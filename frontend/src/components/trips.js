        ...
        return (
            <div>
                ...
                <div className='d-flex flex-wrap justify-content-around'>
                    ...
                    <div className='inlinediv' style={{ 'width': '70%', 'height': '200px' }}>
                        <div style={{ 'width': '99%', 'height': "30px", 'backgroundColor': "#ad679d", 'color': 'white' }}>
                            <h5 style={{ 'marginLeft': '15px' }}>Day1</h5>
                        </div>

                        <p style={{ 'marginTop': '8px' }}>we will start our trip be visiting The Terraces of the Baháʼí Faith
                    ...
                    <div className='inlinediv' style={{ 'width': '27%', 'height': '200px' }}>
                ...
                <div>
                    <p align="right" style={{ 'marginRight': '12px' }}>
                        <input className='btn btn-primary' type="button" value="Book this trip" />
                    </p>
                </div>
            </div>
        )
